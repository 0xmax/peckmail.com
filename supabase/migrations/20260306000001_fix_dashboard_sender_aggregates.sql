-- Fix dashboard aggregates to respect soft-deleted tags/read state and add unique daily volume.
-- Also make sender daily stats refresh rebuild project rows so stale counts cannot linger.
...
BEGIN
  IF p_project_id IS NULL THEN
    DELETE FROM sender_daily_stats;
  ELSE
